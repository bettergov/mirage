 ...
 */
function mirage_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['mirage_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('mirage sample setting'),
  '#default_value' => theme_get_setting('mirage_example'),
